...
export async function init(targetPath: string, options?: { wizard?: boolean }): Promise<void> {
  let config: KikiConfig;
  ...
  if (config.paths.decisions) console.log(`  Decisions: ${config.paths.decisions}`);
